...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_onnx_2fonnx_2doperators_2eproto;
namespace onnx {
class FunctionProto;
...
template <>
::onnx::OperatorSetProto* Arena::CreateMaybeMessage<::onnx::OperatorSetProto>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace onnx {
...
inline const std::string& OperatorStatus_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, OperatorStatus>::value || ::std::is_integral<T>::value,
      "Incorrect type passed to function OperatorStatus_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
      OperatorStatus_descriptor(), enum_t_value);
}
inline bool OperatorStatus_Parse(const std::string& name,
...
class FunctionProto : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx.FunctionProto)
                                                               */
{
 public:
  FunctionProto();
  ...
  private:
   static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
     ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
         &::descriptor_table_onnx_2fonnx_2doperators_2eproto);
     return ::descriptor_table_onnx_2fonnx_2doperators_2eproto
  ...
  public:
   ...
   const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& attribute()
       const;
...
class OperatorProto : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx.OperatorProto)
                                                               */
{
 public:
  OperatorProto();
...
class OperatorSetProto : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx.OperatorSetProto)
                                                                  */
{
 public:
  OperatorSetProto();
...
inline void FunctionProto::set_since_version(
...
inline ::onnx::OperatorSetIdProto* FunctionProto::mutable_opset_import(
    int index) {
...
inline const ::onnx::OperatorSetIdProto& FunctionProto::opset_import(
    int index) const {
...
inline void OperatorProto::set_since_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000004u;
  since_version_ = value;
...
inline std::string* OperatorSetProto::release_magic() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return magic_.ReleaseNonDefaultNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void OperatorSetProto::set_allocated_magic(std::string* magic) {
  ...
  magic_.SetAllocatedNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), magic);
...
inline void OperatorSetProto::set_ir_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000020u;
  ir_version_ = value;
...
inline void OperatorSetProto::clear_ir_version_prerelease() {
  ir_version_prerelease_.ClearToEmptyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000002u;
}
...
inline void OperatorSetProto::set_ir_version_prerelease(
...
inline std::string* OperatorSetProto::mutable_ir_version_prerelease() {
  ...
  return ir_version_prerelease_.MutableNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* OperatorSetProto::release_ir_version_prerelease() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return ir_version_prerelease_.ReleaseNonDefaultNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void OperatorSetProto::set_allocated_ir_version_prerelease(
  ...
  ir_version_prerelease_.SetAllocatedNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void OperatorSetProto::clear_ir_build_metadata() {
  ir_build_metadata_.ClearToEmptyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline std::string* OperatorSetProto::mutable_ir_build_metadata() {
  ...
  return ir_build_metadata_.MutableNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* OperatorSetProto::release_ir_build_metadata() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return ir_build_metadata_.ReleaseNonDefaultNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void OperatorSetProto::set_allocated_ir_build_metadata(
  ...
  ir_build_metadata_.SetAllocatedNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ir_build_metadata);
...
inline void OperatorSetProto::set_opset_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000040u;
...
inline void OperatorSetProto::set_allocated_doc_string(
