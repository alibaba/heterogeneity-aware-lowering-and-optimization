...
#ifndef ODLA_TRT_BATCHED_NMS_INFERENCE_H
#define ODLA_TRT_BATCHED_NMS_INFERENCE_H
#include "plugin.h"
...
pluginStatus_t nmsInference(
    ...
    void* nmsedScores, void* nmsedClasses, void* nmsedIndices, void* workspace,
    bool isNormalized = true, bool confSigmoid = false, bool clipBoxes = true);
#endif // ODLA_TRT_BATCHED_NMS_INFERENCE_H
