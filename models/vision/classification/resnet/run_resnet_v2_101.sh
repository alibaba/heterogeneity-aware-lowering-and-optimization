...
# RUN: FileCheck --input-file /tmp/resnet101-v2-7_dnnl.txt %s
...
# RUN: FileCheck --input-file /tmp/resnet101-v2-7_tensorrt.txt %s
fi

# CHECK: /tmp/images/dog.jpg ==> "Samoyed, Samoyede",
# CHECK-NEXT: /tmp/images/sport.jpg ==> "ski",
# CHECK-NEXT: /tmp/images/food.jpg ==> "plate",
# CHECK-NEXT: /tmp/images/plane.jpg ==> "warplane, military plane",