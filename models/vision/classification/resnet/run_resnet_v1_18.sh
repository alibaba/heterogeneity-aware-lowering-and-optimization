...
model_url="https://github.com/onnx/models/raw/master/vision/classification/resnet/model/resnet18-v1-7.onnx"
model_file="$TEST_TEMP_DIR/resnet18-v1-7.onnx"
...
# RUN: FileCheck --input-file %test_temp_dir/resnet18-v1-7_tensorrt.txt %s
...
# RUN: FileCheck --input-file %test_temp_dir/resnet18-v1-7_dnnl.txt %s
fi

# CHECK: dog.jpg ==> "Samoyed, Samoyede",
# CHECK-NEXT: sport.jpg ==> "ski",
# CHECK-NEXT: food.jpg ==> "chocolate sauce, chocolate syrup",
