...
model_file="/models/vision/classification/squeezenet/$model_name""_1.onnx"
image_dir="/models/vision/test_images"
curr_dir=`dirname $0`

# Using Tensorrt to compile and run inference.
echo "=======Testing squeezenet_1_1 with TensorRT======="
python3 $curr_dir/../../onnx2tensorrt.py --model $model_file --image_dir $image_dir
