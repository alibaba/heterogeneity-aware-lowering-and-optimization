...
model_file="$docker_model_file/$model_name-v1-9.onnx"
...
echo "=======Testing inception_v1 with TensorRT======="
for i in 1
do 
python3 $curr_dir/../../onnx2tensorrt.py --batch_size $i --model $model_file --label-file $curr_dir/../1000_labels.txt --img-preprocess=minus_128
done
