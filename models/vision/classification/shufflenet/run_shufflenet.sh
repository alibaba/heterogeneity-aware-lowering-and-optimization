...
# RUN: FileCheck --input-file /tmp/shufflenet_tensorrt.txt %s
fi
...
# RUN: FileCheck --input-file /tmp/shufflenet_xnnpack.txt %s
...
# CHECK-NEXT: /tmp/images/plane.jpg ==> "liner, ocean liner",