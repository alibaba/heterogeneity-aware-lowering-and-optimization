...
void GenericLLVMIRCodeGen::RunOnInstruction(SItoFPInst* inst) {
  ...
  llvm::Type* fp_ptr_type = ir_builder->getFloatTy()->getPointerTo();
  llvm::FunctionType* ftype = llvm::FunctionType::get(
      ir_builder->getVoidTy(), {fp_ptr_type, data_ptr_type, i64_type}, false);
  ...
  auto ret_buf_ptr = ir_builder->CreateBitCast(ret_buf, fp_ptr_type);
