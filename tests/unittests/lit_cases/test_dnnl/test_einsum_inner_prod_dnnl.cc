//===-test_einsum_inner_prod_dnnl.cc-----------------------------------------------------------===//
//
...
// RUN: %cxx -g %s %t.o %t.bin -I%T -I%odla_path/include -I%unittests_path -I%data_path/test_einsum_inner_prod/test_data_set_0 %odla_link %device_link -lodla_dnnl -o %t_dnnl.exe -Wno-deprecated-declarations
// RUN: %t_dnnl.exe 0.0001 0 dnnl %data_path/test_einsum_inner_prod | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_einsum_inner_prod_dnnl.cc.tmp.main.cc.in"
