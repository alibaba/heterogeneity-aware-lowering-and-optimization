//===-test_split_variable_parts_2d_xnnpack.cc-----------------------------------------------------------===//
//
...
// RUN: %cxx -g %s %t.o %t.bin -I%T -I%odla_path/include -I%unittests_path -I%data_path/test_split_variable_parts_2d/test_data_set_0 %odla_link %device_link -lodla_xnnpack -o %t_xnnpack.exe -Wno-deprecated-declarations
// RUN: %t_xnnpack.exe 0.0001 0 xnnpack %data_path/test_split_variable_parts_2d | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_split_variable_parts_2d_xnnpack.cc.tmp.main.cc.in"
