//===-test_split_variable_parts_2d_popart.cc-----------------------------------------------------------===//
//
...
// RUN: %t_popart.exe 0.0001 0 popart %data_path/test_split_variable_parts_2d | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_split_variable_parts_2d_popart.cc.tmp.main.cc.in"
