//===-test_einsum_batch_matmul_popart.cc-----------------------------------------------------------===//
//
...
// RUN: %cxx -g %s %t.o %t.bin -I%T -I%odla_path/include -I%unittests_path -I%data_path/test_einsum_batch_matmul/test_data_set_0 %odla_link %device_link -lodla_popart -o %t_popart.exe -Wno-deprecated-declarations
// RUN: %t_popart.exe 0.0001 0 popart %data_path/test_einsum_batch_matmul | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_einsum_batch_matmul_popart.cc.tmp.main.cc.in"
