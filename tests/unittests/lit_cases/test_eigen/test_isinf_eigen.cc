...
// RUN: %cxx -g %s %t.o %t.bin -I%T -I%odla_path/include -I%unittests_path -I%data_path/test_isinf/test_data_set_0 %odla_link %device_link -lodla_eigen -o %t_eigen.exe -Wno-deprecated-declarations
// RUN: %t_eigen.exe 0.0001 0 eigen %data_path/test_isinf | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_isinf_eigen.cc.tmp.main.cc.in"
