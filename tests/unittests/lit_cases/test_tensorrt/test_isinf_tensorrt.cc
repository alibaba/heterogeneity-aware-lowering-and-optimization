...
// RUN: %cxx -g %s %t.o %t.bin -I%T -I%odla_path/include -I%unittests_path -I%data_path/test_isinf/test_data_set_0 %odla_link %device_link -lodla_tensorrt -o %t_tensorrt.exe -Wno-deprecated-declarations
// RUN: %t_tensorrt.exe 0.0001 0 tensorrt %data_path/test_isinf | FileCheck %s
// CHECK: Result Pass
// clang-format on
// XFAIL: *
#include "test_isinf_tensorrt.cc.tmp.main.cc.in"
